...
ax = plt.gca();
eda['particip_dif_act_sat'].sort_values().plot(kind='barh');
# ax.set_ylabel([i for i in eda['state'][eda['particip_dif_act_sat'].sort_values().index]]);
```
...
![png](/images/starter-code_files/starter-code_160_0.png)
